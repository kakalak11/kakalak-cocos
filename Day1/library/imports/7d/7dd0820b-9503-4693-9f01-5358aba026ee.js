"use strict";
cc._RF.push(module, '7dd08ILlQNGk58BU1iroCbu', 'project');
// Run/build/web-desktop/src/project.js
...
window.__require = function t(e, s, i) {
  function n(o, a) {
    ...
    "use strict";
    cc._RF.push(e, "6d2330aUMFMUp5X9oVqB6Yo", "Day2"), cc._RF.pop();
  }, {}], ScriptA: [function (t, e, s) {
    "use strict";
    cc._RF.push(e, "2386aMLPS9ALre/lLNyBJ2Y", "ScriptA"), cc.Class({ extends: cc.Component, editor: { executionOrder: 2 }, onLoad: function onLoad() {
        cc.log("script a");
      }, start: function start() {} }), cc._RF.pop();
  }, {}], ScriptB: [function (t, e, s) {
    "use strict";
    cc._RF.push(e, "c595dOm16NBuop83s5Ahxwm", "ScriptB"), cc.Class({ extends: cc.Component, editor: { executionOrder: 1 }, onLoad: function onLoad() {
        cc.log("script b");
      }, start: function start() {} }), cc._RF.pop();
  }, {}], ScriptC: [function (t, e, s) {
    "use strict";
    cc._RF.push(e, "64f4fI+ENhHpb8IuhN77Dst", "ScriptC"), cc.Class({ extends: t("ScriptA"), properties: {}, start: function start() {} }), cc._RF.pop();
  }, { ScriptA: "ScriptA" }], item: [function (t, e, s) {
    "use strict";
    cc._RF.push(e, "f12808+xUtLM7JtuWQa/lJA", "item"), cc.Class({ extends: cc.Component, properties: { itemName: { default: "" }, itemLevel: { default: 0 } }, start: function start() {} }), cc._RF.pop();
  }, {}], labelScript: [function (t, e, s) {
    "use strict";
    cc._RF.push(e, "0db7f+kXvdE+a0L7FQ7LY0Q", "labelScript"), cc.Class({ extends: cc.Component, properties: {}, addLabel: function addLabel() {
    ...
    "use strict";
    cc._RF.push(e, "14d88THZt9AyprzqAZe4Nl6", "layoutScript"), cc.Class({ extends: cc.Component, properties: { labelPrefab: { default: 0, type: cc.Prefab, _position: { x: 0, y: 0 } } }, onLoad: function onLoad() {}, start: function start() {
    ...
    "use strict";
    cc._RF.push(e, "1719fL4tpxHnLb1jXKB2rr0", "left"), cc.Class({ extends: cc.Component, properties: { button: cc.Button }, onLoad: function onLoad() {
    ...
    "use strict";
    cc._RF.push(e, "87dcf2D2FZEUrf8WIlu5UYq", "mainNode");var i = t("utils");cc.Class({ extends: cc.Component, properties: { button: cc.Button, content: cc.Layout, editBox: cc.EditBox, itemPrefab: cc.Prefab }, onClick: function onClick() {
    ...
    "use strict";
    cc._RF.push(e, "32513bxTFhI+qq3ZcSK52Hy", "main");var i = t("utils");t("../../Script/utils").displayCorrect;cc.Class({ extends: cc.Component, properties: { userNameBox: cc.EditBox, userNameMessage: cc.Node, emailBox: cc.EditBox, emailMessage: cc.Node, passWordBox: cc.EditBox, passWordMessage: cc.Node, confirmBox: cc.EditBox, confirmMessage: cc.Node, signUpButton: cc.Button, congratulation: cc.Node, congratulationLabel: cc.RichText, list: cc.Node, listContent: cc.Node, listPrefab: cc.Prefab, _checkingUserName: null, _checkingEmail: null, _checkingPassWord: null, _checkingConfirm: null, _userNameList: [] }, onUserNameInputBegan: function onUserNameInputBegan() {
    ...
    "use strict";
    cc._RF.push(e, "99b1dHoo2VOEr+BkL2yPf84", "pageview"), cc.Class({ extends: cc.Component, properties: { label: cc.Label }, pageTurn: function pageTurn() {
    ...
    "use strict";
    cc._RF.push(e, "306c4XszbhOoLKQw7/v3a6m", "prefab button"), cc.Class({ extends: cc.Component, properties: {}, start: function start() {} }), cc._RF.pop();
  }, {}], richTextScript: [function (t, e, s) {
    "use strict";
    cc._RF.push(e, "95d5eyFLQpCnLF9+bBUKy+L", "richTextScript");var i = t("utils");cc.Class({ extends: cc.Component, properties: {}, onLoad: function onLoad() {
    ...
    "use strict";
    cc._RF.push(e, "edfdarhRbFH4poy34EycdqJ", "right"), cc.Class({ extends: cc.Component, properties: { button: cc.Button }, onLoad: function onLoad() {
        this.button.node.on("click", this.callback, this);
      }, callback: function callback(t) {
        this.node.x += 10;
      }, update: function update(t) {} }), cc._RF.pop();
    ...
    "use strict";
    cc._RF.push(e, "f3f08FOtaJA+5HIrLDSTNvB", "slider"), cc.Class({ extends: cc.Component, properties: { label: cc.Label }, onSlide: function onSlide() {
    ...
    "use strict";
    cc._RF.push(e, "ffd38AgBsZLDZ3D5FcsYSe8", "up"), cc.Class({ extends: cc.Component, properties: { button: cc.Button }, onLoad: function onLoad() {
        this.button.node.on("click", this.callback, this);
      }, callback: function callback(t) {
    ...
    "use strict";
    cc._RF.push(e, "2e803qp/LtJy4tr7EeUToWy", "utils"), console.log("Utilities");var i = { check: function check() {
        ...
        var e = t.split(""),
          ...
          return t.forEach(function (t) {
            parseInt(t) || "0" === t || t === t.toUpperCase() && s++;
          }), !!s;
        }(e) || !function (t) {
          return t.forEach(function (t) {
            parseInt(t) || "0" === t || t === t.toLowerCase() && i++;
          }), !!i;
        }(e)) return !1;return cc.log(s, i, e), !0;
    ...
    "use strict";
    cc._RF.push(e, "783f2U4w5JEkYqcXvzqoJo0", "walk"), cc.Class({ extends: cc.Component, properties: { leftButton: cc.Button, rightButton: cc.Button, jumpButton: cc.Button, speed: { default: 2, serializable: !1 }, moveLeft: { default: !1 }, moveRight: { default: !1 }, jump: { default: !1 }, rotateSpeed: { default: 6, type: cc.Float }, counter: { default: 0 }, fps: { default: 60 }, canClick: { default: !0 } }, onClickLeft: function onClickLeft() {
  ...
  }, {}] }, {}, ["main", "walk", "Day2", "pageview", "slider", "ScriptA", "ScriptB", "ScriptC", "left", "mainNode", "signUpForm", "item", "prefab button", "richTextScript", "right", "labelScript", "layoutScript", "up", "utils"]);
